...
- AIAction: internal AI intent or action before it is converted into a game command.
- Faceoff: deterministic restart that places players and puck before play resumes.
- GameCommand: input or AI command submitted for a specific simulation tick.
- GameEvent: authoritative event emitted by rules after a simulation tick resolves.
- GameState: complete authoritative simulation state.
